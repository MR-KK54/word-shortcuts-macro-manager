...
'WordToolkit_Setup.bat': `@echo off
title Microsoft Word Toolkit - Clean Windows Setup (.bat)
color 0A
echo ====================================================
echo  Microsoft Word Toolkit - Clean Windows Setup
echo ====================================================
echo.
...
$('#m-save').addEventListener('click', async () => {
  ...
  if (!rawName) {
    status.textContent = 'Please enter a macro name.';
  ...
  try {
    ...
    status.textContent = 'Error saving macro: ' + err.message;
    status.className = 'status-msg err';
  }
});
